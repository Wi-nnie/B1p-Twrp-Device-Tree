...
DEVICE_PATH := device/tecno/TECNO-B1p
...
# Assert
TARGET_OTA_ASSERT_DEVICE := TECNO-B1p

# Bootloader"
TARGET_BOOTLOADER_BOARD_NAME := CY-B1P-F8017
...
TARGET_KERNEL_SOURCE := kernel/tecno/TECNO-B1p
TARGET_KERNEL_CONFIG := TECNO-B1p_defconfig
